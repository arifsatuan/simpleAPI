...
class Ujian 
{
	...
	public  function get_mhss()
	{
		...
		$response=array(
							'status' => 1,
							'message' =>'Data Siswa yang terhubung dengan internet',
							'data' => $data
						);
		header('Content-Type: application/json');
		//echo json_encode($response)
		//print_r($response) ;
		print ("Data Siswa connect Internet \n");
		print ("-------------------------------- \n");
		foreach ($data as $data){
		print $data->id."\t".$data->time."\t".$data->nama;
		print ("\n");
}
